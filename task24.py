...
print('Введите количество кустов на круглой грядке:')
n = int(input())
arr = list()
print('Введите количество ягод на кустах:')
for i in range(n):
    print('На', i+1, 'кустике')
    x = int(input())
    arr.append(x)
...
print('Самое большое количество ягод, которые можно собрать на 3 кустах, находящихся рядом: ')
print(max(arr_count))
